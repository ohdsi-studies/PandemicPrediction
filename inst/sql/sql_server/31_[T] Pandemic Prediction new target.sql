...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37311061,704996,704995,704999,704997)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37311061,704996,704995,704999,704997)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (756055,3966513,36032061,1617448,36033647,36033643,36033651,706158,706169,36661384,36661376,36032352,36031861,36031949)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (756055,3966513,36032061,1617448,36033647,36033643,36033651,706158,706169,36661384,36661376,36032352,36031861,36031949)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37310258,21492988,37020635,21492989,37021252,37021152)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37310258,21492988,37020635,21492989,37021252,37021152)
  and c.invalid_reason is null
...
WHERE C.value_as_concept_id in (9189,9190,3661867,4132135,45878583,45880296,45884086,46237074)
-- End Measurement Criteria

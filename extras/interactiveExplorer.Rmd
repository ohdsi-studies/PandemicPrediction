...
sharedResults <- SharedData$new(unifiedResults, ~fullName)
```
<style>
...
# Create the plot
p <- plot_ly(data=sharedResults, source = "main_plot") |>
  ...
  add_markers(
    data = allResults |> dbplyr::filter(analysisId != "dev"),

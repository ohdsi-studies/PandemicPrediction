...
p <- plot_ly(source = "main_plot") |>
  ...
  # Inline legend labels (color-coded, near right edge)
  add_text(
    data = sharedLabels,
    split = ~fullName, color = ~fullName, colors = palette,
    x = ~labelX, y = ~labelY, text = ~legendLabel,
